            ...
            <div className="sm:text-base text-sm  container mx-auto px-4 py-5 font-semibold">
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex space-x-4">
                        {isAuthenticated ? (
                            <>
                                <p className="text-white flex items-center justify-center gap-0.5 sm:gap-1 bg-zinc-100/20 px-2 sm:px-3 py-0.5 sm:py-1 rounded-md  transition-all cursor-pointer shadow-[1px_1px_0_0] shadow-white hover:shadow-none">
                                ...
                                <button className="bg-red-300 text-black px-2 py-1 rounded-md " onClick={async () => {
                                    await logoutAPI();
                                    setUser([])
                                }}>
                                    Logout
                            ...
                            <>
                                <Link to="/login" className={`bg-blue-300 text-black py-1 px-2 rounded-md`}>
                                    Login
                                </Link>
                                <Link to="/register" className={`bg-blue-300 text-black py-1 px-2 rounded-md`}>
                                    Register
                                </Link>
                            </>
                        )}
